      ...
      <div className="project-modal">
        ...
        <div className="project-modal-content">
          <label className="round-check">
            ...
            프리랜서 사업자와 계약
            {
              resultData.OUTSOURCING_YN=='1'? 
              <input type="checkbox" name="outsourcing_yn" onChange={onChange} defaultChecked="checked"/>
               : 
          ...
          <label className="round-check">
            ...
            {
              resultData.STAY_YN=='1'? 
              <input type="checkbox" name="stay_yn" onChange={onChange} defaultChecked="checked"/>
              : 
          ...
          <label className="round-check">
            ...
            정부지원금 사용 시, 체크해주세요
            {
              resultData.GOV_SUPPORT=='1'? 
              <input type="checkbox" name="gov_support" onChange={onChange} defaultChecked="checked"/>
              : 
